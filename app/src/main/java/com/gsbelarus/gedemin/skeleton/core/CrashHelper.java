...
public final class CrashHelper {
    ...
    /**
     * Installs CrashHelper on the application using the default error activity.
     *
        ...
        try {
            if (context == null) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                    Log.w(TAG, "CrashHelper will be installed, but may not be reliable in API lower than 14");
                }
                ...
                if (oldHandler != null && oldHandler.getClass().getName().startsWith(CAOC_HANDLER_PACKAGE_NAME)) {
                    Log.e(TAG, "You have already installed CrashHelper, doing nothing!");
                } else {
                    if (oldHandler != null && !oldHandler.getClass().getName().startsWith(DEFAULT_HANDLER_PACKAGE_NAME)) {
                        Log.e(TAG, "IMPORTANT WARNING! You already have an UncaughtExceptionHandler, are you sure this is correct? If you use ACRA, Crashlytics or similar libraries, you must initialize them AFTER CrashHelper! Installing anyway, but your original handler will not be called.");
                    }
                    ...
                    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            Log.e(TAG, "App has crashed, executing CrashHelper's UncaughtExceptionHandler", throwable);
                    ...
                    Log.i(TAG, "CrashHelper has been installed.");
                }
            }
        } catch (Throwable t) {
            Log.e(TAG, "An unknown error occurred while installing CrashHelper, it may not have been properly initialized. Please report this as a bug if needed.", t);
        }
    }
    ...
    public static boolean isShowErrorDetailsFromIntent(Intent intent) {
        return intent.getBooleanExtra(CrashHelper.EXTRA_SHOW_ERROR_DETAILS, true);
    }
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CrashHelper.EXTRA_IMAGE_DRAWABLE_ID, R.drawable.customactivityoncrash_error_image);
    }
    ...
    public static String getStackTraceFromIntent(Intent intent) {
        return intent.getStringExtra(CrashHelper.EXTRA_STACK_TRACE);
    }
    ...
    public static Class<? extends Activity> getRestartActivityClassFromIntent(Intent intent) {
        Serializable serializedClass = intent.getSerializableExtra(CrashHelper.EXTRA_RESTART_ACTIVITY_CLASS);
    ...
    public static EventListener getEventListenerFromIntent(Intent intent) {
        Serializable serializedClass = intent.getSerializableExtra(CrashHelper.EXTRA_EVENT_LISTENER);
    ...
    public static void setLaunchErrorActivityWhenInBackground(boolean launchErrorActivityWhenInBackground) {
        CrashHelper.launchErrorActivityWhenInBackground = launchErrorActivityWhenInBackground;
    }
    ...
    public static void setShowErrorDetails(boolean showErrorDetails) {
        CrashHelper.showErrorDetails = showErrorDetails;
    }
    ...
    public static void setDefaultErrorActivityDrawable(int defaultErrorActivityDrawableId) {
        CrashHelper.defaultErrorActivityDrawableId = defaultErrorActivityDrawableId;
    }
    ...
    public static void setEnableAppRestart(boolean enableAppRestart) {
        CrashHelper.enableAppRestart = enableAppRestart;
    }
    ...
    public static void setErrorActivityClass(Class<? extends Activity> errorActivityClass) {
        CrashHelper.errorActivityClass = errorActivityClass;
    }
    ...
    public static void setRestartActivityClass(Class<? extends Activity> restartActivityClass) {
        CrashHelper.restartActivityClass = restartActivityClass;
    }
    ...
    public static void setEventListener(EventListener eventListener) {
        if (eventListener != null && eventListener.getClass().getEnclosingClass() != null && !Modifier.isStatic(eventListener.getClass().getModifiers())) {
            ...
            CrashHelper.eventListener = eventListener;
        }
    }
    ...
    private static Class<? extends Activity> guessErrorActivityClass(Context context) {
        ...
        //Else, get the default launcher activity
        if (resolvedActivityClass == null) {
            resolvedActivityClass = DefaultActivityCrash.class;
        }
