...
import com.gsbelarus.gedemin.skeleton.base.data.BaseDatabaseOpenHelperDelegate;
...
public class CoreDatabaseManager extends BaseDatabaseManager {
    ...
    private BaseDatabaseOpenHelperDelegate dbOpenHelperImpl = new BaseDatabaseOpenHelperDelegate() {
...
//            createDemoData(db);
        ...
        private void createDemoData(SQLiteDatabase db) { //TODO
    ...
    @NonNull
    @Override
    protected BaseDatabaseOpenHelperDelegate getDatabaseOpenHelperDelegate() {
