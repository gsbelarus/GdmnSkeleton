...
public class CoreDetailCursorFragment extends BaseDetailCursorFragment {
    ...
    protected LinkedHashMap<View, View> valueViewLabelViewMap;
    ...
    protected void doOnCreateView(ViewGroup rootView, @Nullable Bundle savedInstanceState) {
        valueViewLabelViewMap = CoreUtils.includeCoreDetailView(rootView, getOriginalFrom().length);
    }

    @Override
    protected void bindViewOnCursorLoaded() {
        CoreUtils.bindViews(getDataCursor(), getOriginalFrom(), valueViewLabelViewMap);
    }
